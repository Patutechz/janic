...
import ExpressImg from "../assets/img/cargo.jpg";
import PlaneImg from "../assets/img/plane.jpg";
import CrateImg from "../assets/img/crate.jpg";
...
const SERVICES = [
  ...
  //   desc: "Same-day and next-day delivery within city limits with full real-time tracking.",
  // },
  // {
  //   icon: "fa-plane",
  //   title: "International Freight",
  //   desc: "Door-to-door worldwide delivery across 80+ countries with customs clearance.",
  // },
  // {
  //   icon: "fa-ship",
  //   title: "Sea Freight",
  //   desc: "Cost-effective FCL & LCL ocean freight with live vessel tracking.",
  // },
  {
    icon: "fa-warehouse",
    title: "Consignment Storage",
    desc: "Secure, climate-controlled warehousing for short and long-term storage.",
  },
  {
    icon: "fa-snowflake",
    title: "Cold Chain Logistics",
    desc: "Temperature-controlled transport for pharmaceuticals and perishables.",
  },
  {
    icon: "fa-route",
    title: "Last-Mile Delivery",
    desc: "Precision final-leg delivery with GPS tracking and proof of delivery.",
  },
];
...
const HOW = [
  {
    ...
    icon: "fa-box",
    title: "Book Online",
    desc: "Get an instant quote and book your pickup online in under 60 seconds.",
  },
  {
    n: "02",
    icon: "fa-truck-pickup",
    title: "We Collect",
    desc: "Our trained couriers collect from your door at your scheduled time.",
  },
  {
    n: "03",
    icon: "fa-satellite",
    title: "We Track It",
    desc: "Full chain-of-custody visibility — tracked every step of the way.",
  },
  {
    n: "04",
    icon: "fa-check-circle",
    title: "Delivered",
    desc: "Recipient gets the package with photo confirmation. You're notified instantly.",
  },
];
...
const TESTIMONIALS = [
  {
    name: "Adaeze Okonkwo",
    role: "Operations Manager, BoldRetail",
    text: "Janic World Wide transformed how we move stock. Reliable, transparent, and the tracking is excellent.",
  },
  {
    name: "James Whitmore",
    role: "E-commerce Seller, Manchester",
    text: "The only courier that consistently delivers on time. Live chat support is a lifesaver.",
  },
  {
    name: "Dr. Kemi Ade",
    role: "Export Director, PharmaPlus",
    text: "Our cold chain consignments are always handled flawlessly. Temperature logs are spot on.",
  },
];
...
const Home = () => {
  ...
  const handleSearch = async (e) => {
    ...
    if (error || !data) {
      Swal.fire(
        "Not Found",
        "No package found for that tracking number.",
        "error",
      );
    } else {
      Swal.fire({
  ...
  const boxHover = (e, on) => {
    ...
    e.currentTarget.style.boxShadow = on
      ? `0 16px 40px rgba(124,58,237,0.13)`
      : "";
  };
    ...
    <>
        ...
        <div className="container">
          <div className="columns is-vcentered">
            ...
            <div className="column is-6">
              ...
              >
                From express city deliveries to international freight and secure
                consignment storage — Janic World Wide keeps your supply chain
                moving with full visibility.
              </p>
              ...
              <form onSubmit={handleSearch} style={{ marginBottom: "1.5rem" }}>
                <div className="field has-addons" style={{ maxWidth: "500px" }}>
                  ...
                  <div className="control">
                    <button
                      className="button is-primary is-mediumm has-text-weight-bold"
      ...
      <section className="section" style={{ background: LIGHT }}>
        <div className="container">
          <div className="has-text-centered mb-6">
            ...
            >
              Logistics Built{" "}
              <span className="has-text-primary">for Scale</span>
            </h2>
          </div>
          <div className="columns is-multiline">
            <div className="column is-4-desktop is-6-tablet is-12-mobile">
              <div
                ...
                onMouseEnter={(e) => boxHover(e, true)}
                onMouseLeave={(e) => boxHover(e, false)}
              >
                <img src={ExpressImg} />
                {/* <div
                  style={{
                ...
                <h3
                  className="title is-5 mb-2 mt-2"
                ...
                >
                  Same-day and next-day delivery within city limits with full
                  real-time tracking
                </p>
              </div>
            </div>
            <div className="column is-4-desktop is-6-tablet is-12-mobile">
              ...
              >
                ...
                <p
                  ...
                  style={{ fontSize: "0.9rem", lineHeight: "1.65" }}
                >
                  Door-to-door worldwide delivery across 80+ countries with
                  customs clearance.
                </p>
              </div>
            </div>
            <div className="column is-4-desktop is-6-tablet is-12-mobile">
              ...
              >
                ...
                <p
                  ...
                  style={{ fontSize: "0.9rem", lineHeight: "1.65" }}
                >
                  Cost-effective FCL & LCL ocean freight with live vessel
                  tracking
                </p>
              </div>
            </div>
            {SERVICES.map((s) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <i
                      className={`fas ${s.icon} has-text-primary`}
                      style={{ fontSize: "1.3rem" }}
                    />
                  </div>
                  <h3
        ...
        <div className="container">
          <div className="columns is-vcentered">
            ...
            <div className="column is-6 is-offset-1-desktop">
              ...
              >
                Track Your Package{" "}
                <span className="has-text-primary">In Real Time</span>
              </h2>
              <p
                className="has-text-grey mb-5"
                style={{ lineHeight: "1.75", fontSize: "0.97rem" }}
              >
                Every shipment gets a unique tracking number the moment it is
                picked up. Follow its entire journey from our depot to your
                recipient's door with timestamped location updates.
              </p>
              {[
      ...
      >
        ...
        >
          ...
          >
            Trusted by <span style={{ color: "#a78bfa" }}>12,000+</span>{" "}
            Businesses Worldwide
          </h2>
          <p style={{ color: "#94a3b8", maxWidth: "460px", fontSize: "1rem" }}>
            From small e-commerce sellers to global corporations — Janic
            WorldWide delivers.
          </p>
        </div>
      </div>
      ...
      <section className="section" style={{ background: DARK }}>
        <div className="container">
          <div className="has-text-centered mb-6">
            ...
            >
              How <span style={{ color: "#a78bfa" }}>Janic WorldWide</span>{" "}
              Works
            </h2>
          </div>
          <div className="columns is-multiline">
            {HOW.map((step, i) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <i
                      className={`fas ${step.icon} has-text-primary`}
        ...
        <div className="container">
          <div className="columns is-vcentered">
            <div className="column is-6">
              ...
              >
                Reliability You Can{" "}
                <span className="has-text-primary">Count On</span>
              </h2>
              <p
                className="has-text-grey mb-5"
                style={{ lineHeight: "1.75", fontSize: "0.97rem" }}
              >
                We have spent a decade building the infrastructure,
                partnerships, and technology to make sure your goods arrive on
                time, every time. Our 99% on-time rate is not a marketing claim
                — it is a guarantee.
              </p>
              <div className="columns is-multiline">
                {[
      ...
      >
        ...
        >
          ...
          >
            Sea, Air &amp; Road —{" "}
            <span style={{ color: "#a78bfa" }}>All Under One Roof</span>
          </h2>
          <p
            style={{ color: "#94a3b8", maxWidth: "400px", fontSize: "0.97rem" }}
          >
      ...
      {/* ═══════════════════════════════════════ CTA BANNER */}
      <section
        style={{ background: P, padding: "4.5rem 1.5rem", textAlign: "center" }}
      >
        <div className="container">
          <h2
            style={{
          ...
          <div className="buttons is-centered">
            <Link
              to="/quote"
              className="button is-white is-medium has-text-weight-bold"
              style={{ color: P }}
            >
              Get a Free Quote
            </Link>
            <Link
              to="/contact"
              className="button is-outlined is-white is-medium has-text-weight-bold"
            >
              Talk to Our Team
            </Link>
          </div>
